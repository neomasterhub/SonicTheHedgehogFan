...
public partial class SonicController
{
  public SonicController()
  {
    ...
    _speedConfig = new(TopSpeed, FrictionSpeed, MinSkiddingSpeed, AccelerationSpeed, DecelerationSpeed, AirTopSpeed, AirAccelerationSpeed, MaxFallSpeed, RollFrictionSpeed, RollDecelerationSpeed, JumpSpeed);
