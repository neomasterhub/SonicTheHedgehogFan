...
public static class SonicConsts
{
  ...
  {
    public const float DpadUnlockTimerSeconds = 0.5f;
    ...
    public static readonly SonicPhysicsModeConfig NormalConfig = new(
      ...
      Normal.MinWallSpeedSpx / SpxPerUnit,
      Normal.MinCeilingSpeedPx / PxPerUnit,
      ...
      Normal.RollMinWallSpeedSpx / SpxPerUnit,
      Normal.RollMinCeilingSpeedSpx / SpxPerUnit,
  ...
  public static class Sizes
  {
    ...
    public static class Big
    {
      ...
      public static readonly Vector2 BoxCollider = new(0.5f, 0.975f);
    }
    ...
    public static class Small
    {
      ...
      public static readonly Vector2 HVRadii = new(HRadius, VRadius);
      public static readonly Vector2 BoxCollider = new(0.5f, 0.65f);
    }
  }
